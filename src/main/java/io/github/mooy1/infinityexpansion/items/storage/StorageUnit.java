...
public final class StorageUnit extends MenuBlock implements DistinctiveItem {
    ...
    /* Menu items */
    private static final ItemStack INTERACTION_ITEM = new SlimefunItemStack("INTERACTION_ITEM",Material.LIME_STAINED_GLASS_PANE,
            "&aQuick Actions",
    ...
    private static final ItemStack LOADING_ITEM = new SlimefunItemStack("LOADING_ITEM",Material.CYAN_STAINED_GLASS_PANE,
            "&bStatus",
            "&7Loading..."
    ).item();
