...
import io.github.mooy1.infinityexpansion.machines.MachineBlock;
...
public final class Machines {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        MaterialGenerator mg = new MaterialGenerator(Groups.BASIC_MACHINES, BASIC_COBBLE, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
        ...
        GrowingMachine gm = new GrowingMachine(Groups.BASIC_MACHINES, BASIC_GROWER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
