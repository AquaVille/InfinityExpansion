...
public final class InfinityReactor extends MenuBlock implements EnergyNetProvider, RecipeDisplayItem {
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        ItemStack item = new CustomItemStack(Materials.INFINITE_INGOT.item(), Materials.INFINITE_INGOT.getDisplayName(),
                "", ChatColor.GOLD + "Lasts for 1 day");
        items.add(item);
        items.add(null);

        item = new CustomItemStack(Materials.VOID_INGOT.item(), Materials.VOID_INGOT.getDisplayName(),
