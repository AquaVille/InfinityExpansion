...
public final class ConfigManager extends YamlConfiguration {
    ...
    private InfinityExpansion plugin;
    private final File file;

    public ConfigManager(String path, InfinityExpansion instance) {
        plugin = instance;
        file = new File(plugin.getDataFolder(), path);
        super.defaults = defaults;
        loadDefaults(plugin, path);
    }
    ...
    private void loadDefaults(InfinityExpansion addon, String name) {
